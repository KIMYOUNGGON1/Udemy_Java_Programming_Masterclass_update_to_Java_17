...
//        NOTE: Do not add a main method to the solution code.
        int greatestCommonDivisor = getGreatestCommonDivisor(81, 153);
    ...
    public static int getGreatestCommonDivisor(int first, int second) {
        ...
        int conditionOfRepeat = 0;
        int greatCommonDivisor = 0;

        if (first > second) {
            conditionOfRepeat = first;
        } else {
            conditionOfRepeat = second;
        }

        for (int i = 1; i <= conditionOfRepeat; i++) {
