...
//        NOTE: Do not add the main method to the solution code.
        int bucketCount1 = getBucketCount(-3.4, 2.1, 1.5, 2);
        System.out.println("This is first getBucketCount method's answer = " + bucketCount1);

//        int bucketCount2 = getBucketCount(3.4, 2.1, 1.5);
//        System.out.println("This is second getBucketCount method's answer = " + bucketCount2);

//        int bucketCount3 = getBucketCount(3.26, 0.75);
//        System.out.println("This is third getBucketCount method's answer = " + bucketCount3);
    }

//    public static int getBucketCount(double width, double height, double areaPerBucket, int extraBuckets) {
//
//        double countLoop = 1.0;
//        boolean isAreaPerBucketSmall = false;
//        int answer = 1;
//
...
//            do {
//                countLoop++;
//                areaPerBucket = (areaPerBucket * countLoop) + extraBuckets;
//
//                isAreaPerBucketSmall = (width * height) > areaPerBucket ? true : false;
//            } while (!isAreaPerBucketSmall);
//        }
//
//        return answer + (int) countLoop;
//    }
//
//    public static int getBucketCount(double width, double height, double areaPerBucket) {
//
//        double countLoop = 1.0;
//        double origianlAreaPerBucketValue = areaPerBucket;
//        boolean isAreaPerBucketSmall = false;
//
...
//            do {
//                countLoop++;
////                System.out.println("This is test for know countLoop's value = " + countLoop);
////                System.out.println("This is test for know area of method = " + (width * height));
//                areaPerBucket = origianlAreaPerBucketValue * countLoop;
////                System.out.println("This is test for know areaPerBucket's value = " + areaPerBucket);
//
//                isAreaPerBucketSmall = (width * height) > areaPerBucket ? false : true;
//            } while (!isAreaPerBucketSmall);
//
//            return (int) countLoop;
//        }
//    }
//
...
////                System.out.println("This is test for know areaPerBucket's value = " + areaPerBucket);
//
//                isAreaPerBucketSmall = (area > areaPerBucket) ? false : true;
//            } while (!isAreaPerBucketSmall);
//
//            return (int) countLoop;
//        }
