...
public class Bedroom {
    ...
    public Bedroom(String name, Wall wall81, Wall wall82, Wall wall83, Wall wall84, Ceiling ceiling, Bed bed, Lamp lamp) {
        this.name = name;
        this.wall81 = wall81;
        this.wall82 = wall82;
        this.wall83 = wall83;
...
//        3) System.out.println("Lamp -> Turning on"); should be used in the turnOn() method of the Lamp class.
        Wall wall81 = new Wall("West");
        Wall wall82 = new Wall("East");
        Wall wall83 = new Wall("South");
        Wall wall84 = new Wall("North");
        ...
        Bedroom bedRoom = new Bedroom("YOUR NAME HERE", wall81, wall82, wall83, wall84, ceiling,bed, lamp);
        bedRoom.makeBed();
