...
public class ComplexNumberChallenge {
    private double real;
    private double imaginary;

    public ComplexNumberChallenge(double real, double imaginary) {
        this.real = real;
    ...
    public void add(ComplexNumberChallenge complexNumberChal) {
        this.real += complexNumberChal.real;
        this.imaginary += complexNumberChal.imaginary;
    }
    ...
    public void subtract(ComplexNumberChallenge complexNumberChal) {
        this.real -= complexNumberChal.real;
        this.imaginary -= complexNumberChal.imaginary;
    }
